...
import com.crm.message.commons.consts.JPushConfig;
...
public class JpushClientUtil{
    ...
    private final static String appKey = JPushConfig.APP_KEY;

    private final static String masterSecret = JPushConfig.SECRET;
...
//            System.out.println(pushResult);
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToAliases (List<String> aliases, /*String notification_title, String msg_title,*/ String msg_content, String extrasparam) {
        return sendToAliases(masterSecret, appKey, aliases, msg_content, extrasparam);
    }

    public static int sendToAliases(String masterSecret, String appKey, List<String> aliases, /*String notification_title, String msg_title,*/ String msg_content, String extrasparam) {
        JPushClient jPushClient = new JPushClient(masterSecret,appKey);
        int result = 0;
        try {
            PushPayload pushPayload= JpushClientUtil.buildPushObject_aliases_alertWithTitle(aliases, /*notification_title,msg_title,*/msg_content,extrasparam);
            System.out.println(pushPayload);
            PushResult pushResult=jPushClient.sendPush(pushPayload);
            System.out.println(pushResult);
            if(pushResult.getResponseCode()==200){
    ...
    private static PushPayload buildPushObject_aliases_alertWithTitle(List<String> aliases,/*String notification_title, String msg_title,*/ String msg_content, String extrasparam) {
